...
class MainActivityItemDisplayedTest {
    ...
    fun testItemIsDisplayed() {
        ...
        Espresso.onView(RecyclerViewMatcher(R.id.recyclerView).atPosition(0))
            .check(matches(hasDescendant(withText(mockedData[0].name))))
    }
}
